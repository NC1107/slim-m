...
Idle RSS was measured at 0.8.0 (7,296 kB steady, 25,760 kB peak against a 30MB ceiling, `perf/baselines/0.8.0.json`) and re-measured once at 0.15.0 (8,748 kB / 26,916 kB, `perf/baselines/0.15.0.json`), still inside budget both times, but nothing re-measures it automatically and it is stale again now the server is three releases past 0.15.0.
