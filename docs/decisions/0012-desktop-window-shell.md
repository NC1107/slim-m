...
Date: 2026-08-10.
Status: built (#533), with the no-tray quit gap below closed 2026-08-11, and the startup-window recommendation superseded 2026-08-27 (see that section at the end).
