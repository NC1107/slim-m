...
//!
//! Refresh-token rotation, its concurrent races, and reuse-triggered family
//! revocation are a separate concern with enough of their own tests to move
//! the whole file past its 500-line hard budget; they live in
//! `auth_refresh.rs`.
