...
/// Message deletion, full-text search, and reactions: the rest of the
/// `messages` tag that [SlimmApi.sendMessage], [SlimmApi.listMessages], and
/// [SlimmApi.editMessage] do not cover.
