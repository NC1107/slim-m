...
final _tsKeywords = {
  ..._jsKeywords,
  ..._words('interface type enum implements public private protected '
      'readonly namespace declare void'),
};

final _pyKeywords =
    _words('def return if elif else for while break continue pass class import '
...
final _rustKeywords =
    _words('fn let mut const static return if else for while loop match break '
...
final _goKeywords =
    _words('func return if else for range switch case break continue package '
        'import var const type struct interface map chan go defer select '
        'fallthrough nil true false make new');

final _javaKeywords =
    _words('public private protected static final class interface extends '
...
final _cKeywords =
    _words('int char float double void short long signed unsigned struct union '
        'enum typedef static const extern return if else for while do switch '
        'case break continue sizeof goto NULL');

final _cppKeywords = {
  ..._cKeywords,
  ..._words('class public private protected virtual namespace using '
      'template typename new delete this try catch throw nullptr auto '
      'constexpr override'),
};

final _csharpKeywords =
    _words('class public private protected static namespace using new this try '
...
final _bashKeywords = _words('if then else elif fi for while do done case '
...
final Map<String, LangSpec> langSpecs = {
  ...
  'sql': LangSpec(
      keywords: _sqlKeywords, lineComment: '--', caseInsensitiveKeywords: true),
  'json':
      const LangSpec(keywords: {'true', 'false', 'null'}, stringChars: {'"'}),
