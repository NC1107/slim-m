...
/// author's [AuthorResolution] out of the batch map via a `.select` (a
/// message row watching the whole map rebuilt on every other author's
/// resolve, not only its own).
