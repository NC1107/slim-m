...
/// Two personal settings sections about the account itself: blocked users,
/// and sign-out or deletion. `DevicesSection` split out to
/// `devices_section.dart`, re-exported here so existing callers are unaffected.
///
