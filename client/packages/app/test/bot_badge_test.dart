...
/// The BOT badge: a reader can tell that something was written by a program
/// without inspecting anything.
///
/// That is the whole requirement decision 0028 places on the interface, and it
/// is only met on the two surfaces that draw a name - a message author line and
/// a member row - so both are covered here rather than only the model.
library;
...
api.UserProfile _profile({bool isBot = false, List<String> roles = const []}) =>
    api.UserProfile(
      id: 'u1',
      username: 'helper',
      displayName: 'Helper',
