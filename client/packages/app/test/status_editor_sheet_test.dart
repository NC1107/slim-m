...
/// the sidebar. Drives it the way `space_menu_button_test.dart` drives its
/// own avatar-adjacent menu - tap the avatar, tap the item, drive the sheet -
...
/// Taller than the default 600, so the menu opening upward off the avatar
/// has room; boxed to the rail footer's own 28pt avatar rather than a bare
/// `Align`, which would hand `PresenceMenuButton` the whole loose screen and
/// inflate its own `Center` to fill it, putting the button's leader link at
/// the screen's corner instead of by the avatar.
...
/// Opens the avatar menu and taps "Set a status", landing on the editor.
...
void main() {
  testWidgets('the avatar menu offers Set a status alongside the presence '
